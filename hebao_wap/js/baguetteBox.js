...
var baguetteBox = (function() {
    ...
    function hideOverlay() {
        ...
        if(overlay.style.display === 'none')
            return;
        if(document.addEventListener){
            document.addEventListener('DOMMouseScroll',scrollTrueFunc,false);
        }//W3C
        window.onmousewheel=document.onmousewheel=scrollTrueFunc;//IE/Opera/Chrome
